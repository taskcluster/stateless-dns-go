...
export RELEASE_FILE="${TRAVIS_BUILD_DIR}/create-hostname-${GIMME_OS}-${GIMME_ARCH}${FILE_EXT}"
mv "${GOPATH}/bin/${GIMME_OS}_${GIMME_ARCH}/create-hostname${FILE_EXT}" "${RELEASE_FILE}"
